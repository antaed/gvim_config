...
let s:mint0 = "009966" " #009966
let s:turqo = "0093B0" " #0093B0
let s:blue0 = "0078F0" " #0078F0
let s:indig = "5E79FF" " #5E79FF
let s:purpl = "7B61FF" " #7B61FF
let s:magen = "B869BF" " #B869BF
let s:coral = "D95B85" " #D95B85
